use crate::*;
#[derive(Clone)]
pub struct DerivativeStreamNode {
    pub in_node: Option<Rc<RefCell<Box<dyn CodeGenNode>>>>,
    pub var_name: Option<String>,
}
impl CodeGenNode for DerivativeStreamNode {
    ...
    fn make_line(&self) -> String {
        let mut output = String::from(format!("let {} = make_input_getter!(DerivativeStream::new(Rc::clone(&", self.get_var_name()));

use crate::*;
#[derive(Clone)]
pub struct VelocityToStateNode {
    pub in_node: Option<Rc<RefCell<Box<dyn CodeGenNode>>>>,
    pub var_name: Option<String>,
}
impl CodeGenNode for VelocityToStateNode {
    ...
    fn make_line(&self) -> String {
        let mut output = String::from(format!("let {} = make_input_getter!(VelocityToState::new(Rc::clone(&", self.get_var_name()));

use crate::*;
#[derive(Clone)]
pub struct IntegralStreamNode {
    pub in_node: Option<Rc<RefCell<Box<dyn CodeGenNode>>>>,
    pub var_name: Option<String>,
}
impl CodeGenNode for IntegralStreamNode {
    ...
    fn make_line(&self) -> String {
        let mut output = String::from(format!("let {} = make_input_getter!(IntegralStream::new(Rc::clone(&", self.get_var_name()));
